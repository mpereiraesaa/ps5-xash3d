...
| 4 — GoldSrc render states | In progress | All 99 semantic states and nine `gfx1013` variants exist; real opaque/masked binding plus a mid-frame viewport/scissor restore passed 10,000 frames with visual proof and zero errors; the remaining state matrix and scene features are open |
