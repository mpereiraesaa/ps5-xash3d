...
| 4 — GoldSrc render states | In progress | Dedicated `PPSA99996` identity passed; 99-state host cache, viewport/scissor and nine compiled `gfx1013` shader variants are green; native/visual gates remain |
