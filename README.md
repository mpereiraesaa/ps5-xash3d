...
| 5 — Platform layer | In progress, engine/FS/ScePad/AudioOut passed | The dedicated Xash3D engine boots, indexes the complete 4,823-entry asset tree and loads `c1a0`; the ScePad backend proved batched movement, look, jump, crouch, use and fire with exact teardown; the SceAudioOut backend then carried 1.5 s of 44.1 kHz PCM to the 48 kHz main port as 282 whole grains with a matching hash and zero underruns. The allocator and direct memory are next |
