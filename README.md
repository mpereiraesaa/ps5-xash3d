...
| 4 — GoldSrc render states | In progress | All 99 semantic states and nine `gfx1013` variants exist; real binding, viewport/scissor and the complete blend/depth/cull/fog/lightmap matrix passed 10,000-frame visual/readback gates with zero errors; the 2D and scene-feature gates remain open |
