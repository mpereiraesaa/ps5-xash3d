...
| `xash/platform_ps5/ref_agc_module.c`, `lib_ps5.c` and the generated `ref_agc.prx` descriptor | Publish Xash RefAPI v18 from an application-owned module and bind its lifecycle/frame callbacks to the accepted Phase 4 AGC backend. | Host contracts pin the 16 descriptor exports, callback surface and strict paired-run validator. Correlated FW 12.02 runs `20260908T191327933Z_PPSA99996_xash3d-engine_0x11059870e2628` and `20260908T191327984Z_PPSA99996_ps5-xash3d_0x110598a25cd2f` exercised `c1a0`, 203,420 begin/end callbacks, one new-map callback and 600 native frames with nonzero GPU hashes/pixels, exact fence/VideoOut ownership and five-module teardown to zero. The renderer scene is the baked Phase 4 `c1a0e` proof bundle; live engine-entity translation remains Phase 7. |
