...
int main( int argc, char **argv )
{
	...
	(void)ps5log_printf( PS5LOG_MARK,
		...
		"filesystem_prx=%d server_prx=%d menu_prx=%d "
		"rodir_present=%d",
		...
		PS5_XASH_SERVER_PRX, PS5_XASH_MENU_PRX,
...

	{
		...
		(void)ps5log_printf( PS5LOG_MARK,
			...
			"prx_gate=%d prx_pass=%d filesystem_prx=%d server_prx=%d menu_prx=%d",
